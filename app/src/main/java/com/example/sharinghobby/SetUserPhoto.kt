...
import com.example.sharinghobby.databinding.ActivitySetUserPhotoBinding
...
class SetUserPhoto : BaseActivity() {
    ...
    val binding by lazy { ActivitySetUserPhotoBinding.inflate(layoutInflater) }
    ...
    fun setViews() {
        binding.setUserCamera.setOnClickListener {
            requirePermissions(arrayOf(android.Manifest.permission.CAMERA), PERM_CAMERA)
        }
        binding.setUserGallary.setOnClickListener {
            openGallery()
        }
    }
    ...
    fun setImageWithGlide1(url:String){
        Glide.with(binding.root.context)
            ...
            .into(binding.userPhoto12)
        binding.Success.visibility= View.VISIBLE
        binding.Success.text="설정완료!"
    }
